<template>
    <div class="wrapper">
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            >
                ...
                <div
                    ...
                    style="margin: 0px -8px; width: 249px; height: 320px"
                ></div>
                ...
                >
                    <div class="os-scrollbar-track">
                        <div
                            ...
                            style="
                                height: 23.6203%;
                                transform: translate(0px, 69.9422px);
                            "
                        ></div>
                    </div>
                </div>
        ...
        <aside
            ...
            style="display: none; top: 56.8px; height: 321.2px"
        >
...
<style scoped>
/* Scoped styles for the Main layout */
header,
aside,
main,
footer {
